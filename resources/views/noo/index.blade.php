                                ...
                                <tbody>
                                    @foreach ($noos as $noo)
                                        <tr>
                                            ...
                                            <td>{{ date('d M Y', $noo->created_at ) }}</td>
                                            ...
                                            <td>{{ $noo->confirmed_at == null ? '-' : date('d M Y', $noo->confirmed_at ) }}
                                            <td>{{ $noo->approved_by ?? '-' }}</td>
                                            <td>{{ $noo->approved_at == null ? '-' : date('d M Y', $noo->approved_at ) }}
                                            </td>
                                            <td>{{ $noo->rejected_by ?? '-' }}</td>
                                            <td>{{ $noo->rejected_at == null ? '-' : date('d M Y', $noo->rejected_at ) }}
                                            </td>
