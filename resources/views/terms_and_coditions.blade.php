...
<body>
    <div class="container">
        ...
        <p>These terms and conditions apply to the SAM (Sales Assistant Mobile) app (hereby referred to as "Application")
            for mobile devices that was created by Complete Selular (hereby referred to as "Service Provider") as a Free
            service.</p>
        ...
        <p>Upon downloading or utilizing the Application, you are automatically agreeing to the following terms. It is
            ...
            and other intellectual property rights related to the Application remain the property of the Service Provider.</p>
        ...
        <p>The Service Provider may wish to update the application at some point. The application is currently available as
            ...
            necessary) delete it from your device.</p>
        ...
        <p>These terms and conditions are effective as of 2025-03-18</p>

        <h2>Contact Us</h2>
        <p>If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the
            Service Provider at <a href="mailto:irfan@completeselular.com">irfan@completeselular.com</a>.</p>
