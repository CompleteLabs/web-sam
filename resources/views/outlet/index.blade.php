                                    ...
                                    @foreach ($outlets as $index => $outlet)
                                        <tr>
                                            ...
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <td>
                                                        <form method="GET" action="/outlet/delete/{{ $outlet->id }}">
                                                        <a href="/outlet/{{ $outlet->id }}" class="badge bg-warning"><span><i
                                                            class="fas fa-edit"></i></span></a>
                                                            @csrf
                                                            <!-- BUTTON DELETE -->
                                                            {{-- <a class="badge bg-danger show_confirm"><span><i
...
<div class="d-flex justify-content-center">
    ...
    <!-- Modal BULK DELETE -->
    <form action="outlet" enctype="multipart/form-data">
        @csrf
        <div class="modal fade" id="bulkDelete" aria-labelledby="bulkDeleteLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="bulkDeleteLabel">Bulk Delete Outlet</h5>
                    </div>
                    <div class="modal-body">
                        <div class="col-12 mt-3">
